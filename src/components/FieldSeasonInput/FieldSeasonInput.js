...
import css from './FieldSeasonInput.module.css';

const CONTENT_MAX_LENGTH = 5000;

class FieldSeasonInputComponent extends Component {
  render() {
...
FieldSeasonInputComponent.defaultProps = {
  rootClassName: null,
  className: null,
  inputRootClass: null,
  onUnmount: null,
...
FieldSeasonInputComponent.propTypes = {
...
class FieldSeasonInput extends Component {
  ...
  render() {
    return <Field component={FieldSeasonInputComponent} {...this.props} />;
  }
}

export default FieldSeasonInput;
